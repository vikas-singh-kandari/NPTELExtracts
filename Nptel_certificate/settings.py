...
SECRET_KEY = os.environ.get('SECRET_KEY', 'unsafe-default-key')  # fallback only for local dev
DEBUG = os.environ.get('DEBUG', 'False') == 'True'  # Convert string to boolean

# Allow Render's domain or your custom one
...
ROOT_URLCONF = 'Nptel_certificate.urls'
...
WSGI_APPLICATION = 'Nptel_certificate.wsgi.application'
